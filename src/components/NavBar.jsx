...
export default function NavBar() {
  ...
  return (
    <Navbar
      className={
        scrolled
          ? "bg-white sticky top-0 py-4 flex items-center justify-between px-4 shadow-[0_1px_rgba(0,0,0,0.075)]"
          : "'bg-transparent sticky top-0 py-4 flex items-center justify-between px-4 shadow-[0_1px_rgba(0,0,0,0.075)]"
      }
    >
